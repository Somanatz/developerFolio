...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/14oZI_tnw5GpffZ1QE0gb6d75m9gJLrQE/view?usp=sharing", // Set to empty to hide the button
...
const twitterDetails = {
  userName: "NarugariObili", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
